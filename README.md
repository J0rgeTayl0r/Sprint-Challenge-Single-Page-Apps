...
> Answer:
The benefits of client-side routing are that,  you download less data to display new content, you can reuse DOM elements, display loading notifications to user etc.
